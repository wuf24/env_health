...
|:-------------|:------------------|--------------:|----------------:|:---------------------|------------------:|--------------:|
| 主模型       | SYS_08952         |      0.868143 |         33.5221 | SSP5-8.5（climate）  |           1.48728 |       3.00623 |
| 严筛主模型   | SYS_09851         |      0.855329 |         34.7017 | SSP5-8.5（climate）  |           1.31087 |       2.63173 |
| 严筛模型 2   | SYS_10001         |      0.891809 |         34.4286 | SSP5-8.5（climate）  |           1.29095 |       2.59633 |
| 严筛模型 3   | SYS_10002         |      0.914797 |         34.666  | SSP5-8.5（climate）  |           1.81068 |       3.18706 |
| 严筛模型 4   | SYS_09941         |      0.979014 |         34.3824 | SSP5-8.5（climate）  |           1.43481 |       2.99034 |
| 严筛模型 5   | SYS_09926         |      0.946959 |         34.5879 | SSP5-8.5（climate）  |           1.47948 |       3.03275 |
| 严筛模型 6   | SYS_09927         |      0.981324 |         34.8673 | SSP5-8.5（climate）  |           2.0165  |       3.61105 |
| 严筛模型 7   | SYS_09791         |      0.984922 |         34.897  | SSP5-8.5（climate）  |           1.59235 |       3.12317 |
| 严筛模型 8   | SYS_09776         |      0.954418 |         35.0155 | SSP5-8.5（climate）  |           1.63373 |       3.1627  |
| 稳健性模型 2 | SYS_09556         |      1.06376  |         32.0123 | SSP5-8.5（climate）  |           1.04066 |       2.48623 |
| 稳健性模型 3 | SYS_09557         |      1.07481  |         31.7098 | SSP5-8.5（climate）  |           1.345   |       2.82192 |
| 稳健性模型 1 | 方案F_低VIF主线组 |      0.872837 |         30.7911 | SSP5-8.5（climate）  |           1.39507 |       2.96267 |
